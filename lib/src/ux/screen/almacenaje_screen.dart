...
class AlmacenajeScreen extends StatefulWidget {
  const AlmacenajeScreen({super.key});

  @override
  State<AlmacenajeScreen> createState() => _AlmacenajeScreenState();
}

class _AlmacenajeScreenState extends State<AlmacenajeScreen> {
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/images/sistemas/fnd_almacenaje.png"),
            fit: BoxFit.cover,
          ),
        ),
        child: Stack(
          children: [
            ...
            Container(
              ...
              child: CarouselSlider(
                  items: sistemasController.marcasAlmacenajePallet,
            ...
            Container(
              ...
              child: CarouselSlider(
                items: sistemasController.marcasAlmacenajeCajas,
                options: CarouselOptions(
                  autoPlay: true,
                  autoPlayAnimationDuration: Duration(seconds: 1),
                  autoPlayInterval: Duration(seconds: 2),

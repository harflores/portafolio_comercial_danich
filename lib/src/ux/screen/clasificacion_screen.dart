...
class ClasificacionScreen extends StatefulWidget {
  ...
  @override
  State<ClasificacionScreen> createState() => _AlmacenajeScreenState();
}

class _AlmacenajeScreenState extends State<ClasificacionScreen> {
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/images/sistemas/fnd_clasificacion.png"),
            fit: BoxFit.cover,
          ),
        ),
        child: Stack(
          children: [
            Container(
              ...
              child: MarkdownBody(
                data: constants.txtClasificacion,
            ...
            Container(
              ...
              child: CarouselSlider(
                  items: sistemasController.marcasClasificacion,

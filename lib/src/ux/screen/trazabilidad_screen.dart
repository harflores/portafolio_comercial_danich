...
class TrazabilidadScreen extends StatefulWidget {
  ...
  @override
  State<TrazabilidadScreen> createState() => _AlmacenajeScreenState();
}

class _AlmacenajeScreenState extends State<TrazabilidadScreen> {
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/images/sistemas/fnd_trazabilidad.png"),
            fit: BoxFit.cover,
          ),
        ),
        child: Stack(
          children: [
            Container(
              ...
              child: MarkdownBody(
                data: constants.txtTrazabilidad,
            ...
            Container(
              ...
              child: CarouselSlider(
                  items: sistemasController.marcasTrazabilidad,
